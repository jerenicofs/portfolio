...
const Hero = () => {
  return (
    <div className="pb-20 pt-24">
      ...
      {/* Grid Background */}
      <div className="h-auto w-full dark:bg-black-100 bg-white  dark:bg-grid-white/[0.02] bg-grid-black/[0.2] flex items-center justify-center absolute top-0 left-0">
